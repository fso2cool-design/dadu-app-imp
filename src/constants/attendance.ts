...
export const ATTENDANCE_STATUS_META: Record<AttendanceStatus, AttendanceStatusMeta> = {
  ...
  DISPENSATION: {
    ...
    badgeClass: 'bg-indigo-50 text-indigo-700 border-indigo-200 dark:bg-indigo-950/60 dark:text-indigo-300 dark:border-indigo-500/40',
    dotClass: 'bg-indigo-500',
    borderClass: 'border-indigo-500',
    activeBtnClass: 'bg-indigo-600 text-white border-indigo-600 shadow-sm shadow-indigo-600/30',
