...
type TeacherTab = 'classes' | 'journal' | 'attendance' | 'grades';
...
export const TeacherHubPage: React.FC<TeacherHubPageProps> = ({
  ...
  const tabs: Array<{ id: TeacherTab; label: string; icon: any }> = [
    ...
    { id: 'journal', label: 'Agenda & Jurnal', icon: CalendarCheck2 },
    { id: 'attendance', label: 'Presensi Mapel', icon: CheckSquare },
