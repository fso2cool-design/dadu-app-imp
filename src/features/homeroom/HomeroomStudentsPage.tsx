...
export const HomeroomStudentsPage: React.FC<HomeroomStudentsPageProps> = ({ onNavigate }) => {
  ...
  // Modals for Progress Report & Exam Cards
  ...
  const [examCardModalOpen, setExamCardModalOpen] = useState<boolean>(false);
  ...
  return (
    <div className="space-y-6">
                          ...
                          <td className="py-3 px-3.5 text-center">
                            <div className="flex items-center justify-center gap-1">
                              ...
                              <button
                                ...
                                className="px-2 py-1 bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-200 rounded-lg text-[11px] font-semibold flex items-center gap-1 transition-colors cursor-pointer"
                                title="Cetak Kartu Ujian Siswa"
                              >
      ...
      {/* Student Exam Card (Kartu Ujian) Modal */}
